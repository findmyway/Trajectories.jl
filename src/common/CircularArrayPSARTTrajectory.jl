const CircularArrayPISARTTrajectory = Trajectory{
    <:Traces{
        PISART,
        <:Tuple{
            <:Trace{<:SumTree},
...
function CircularArrayPISARTTrajectory(;
    capacity::Int,
...
Base.push!(t::CircularArrayPISARTTrajectory, x::NamedTuple)

function Random.rand(s::BatchSampler, t::CircularArrayPSARTTrajectory)
